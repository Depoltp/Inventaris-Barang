                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btns">
                                    <a href="kategori-edit.php?id=<?php echo $kategori['id_kategori']; ?>" class="btn btn-warning btn-sm">
                                        Edit
                                    </a>
                                    <a href="../scripts/hapuskategori.php?id=<?php echo $kategori['id_kategori']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus kategori ini?')">
                                        Hapus
                                    </a>
                                </div>
                            </td>
